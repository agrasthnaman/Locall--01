...
mongoose
.connect(
  `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.wvosk.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`
)
  // .connect(
